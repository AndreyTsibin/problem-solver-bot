    ...
    try:
        async with AsyncSessionLocal() as session:
            ...
            if subscription:
                ...
                text = (
                    f"💳 <b>Доступно решений:</b> {user.problems_remaining}\n\n"
                    f"📦 <b>Оформи подписку для безлимитного доступа!</b>\n\n"
...
async def handle_show_packages(callback: CallbackQuery):
    ...
    text = """💳 <b>Разовые пакеты решений</b>

Покупай решения без подписки:
...
Решения не сгорают — используй когда удобно!"""
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="🟢 Starter (250₽)", callback_data="buy_starter")],
        [InlineKeyboardButton(text="🔵 Medium (600₽)", callback_data="buy_medium")],
        [InlineKeyboardButton(text="🟣 Large (1200₽)", callback_data="buy_large")],
